...
export PATH=$HOME/.cargo/bin:$HOME/.nodebrew/current/bin:$HOME/android-sdk-mac_x86/platform-tools:$HOME/android-sdk-mac_x86/tools:$HOME/bin:/usr/texbin:/opt/local/bin:/opt/local/sbin:$PATH
